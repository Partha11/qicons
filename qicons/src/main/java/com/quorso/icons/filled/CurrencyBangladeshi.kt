    ...
    get() {
        ...
        _CurrencyBangladeshi = ImageVector.Builder(
            ...
            path(
                ...
                close()
                moveTo(10.5f, 7.963f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.17f, -1.341f)
                ...
                arcTo(4.501f, 4.501f, 0f, isMoreThanHalf = false, isPositiveArc = false, 16.41f, 14.4f)
                curveToRelative(0.199f, -0.977f, -0.636f, -1.649f, -1.415f, -1.649f)
                horizontalLineToRelative(-0.745f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, 0f, 1.5f)
                horizontalLineToRelative(0.656f)
                arcToRelative(3.002f, 3.002f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.327f, 1.893f)
                arcToRelative(0.113f, 0.113f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.045f, -0.051f)
                arcToRelative(0.336f, 0.336f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.034f, -0.154f)
