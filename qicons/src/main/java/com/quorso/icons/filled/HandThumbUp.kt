...
val QIcons.Filled.HandThumbUp: ImageVector
    get() {
        if (_HandThumbUp != null) {
            return _HandThumbUp!!
        }
        _HandThumbUp = ImageVector.Builder(
            name = "Filled.HandThumbUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(7.48f, 7.48f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 15.125f)
                ...
                arcToRelative(9.042f, 9.042f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.861f, -2.4f)
                curveToRelative(0.723f, -0.384f, 1.35f, -0.956f, 1.653f, -1.715f)
                arcToRelative(4.498f, 4.498f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.322f, -1.672f)
                verticalLineTo(2.75f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 15f, 2f)
                ...
                arcToRelative(11.95f, 11.95f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.649f, 7.521f)
                ...
                arcToRelative(4.501f, 4.501f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.423f, -0.23f)
                horizontalLineToRelative(-0.777f)
                close()
                moveTo(2.331f, 10.727f)
                arcToRelative(11.969f, 11.969f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.831f, 4.398f)
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.52f, 3.507f)
                curveTo(2.28f, 19.482f, 3.105f, 20f, 3.994f, 20f)
                horizontalLineTo(4.9f)
                curveToRelative(0.445f, 0f, 0.72f, -0.498f, 0.523f, -0.898f)
                arcToRelative(8.963f, 8.963f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.924f, -3.977f)
