...
val QIcons.Filled.Cog6Tooth: ImageVector
    get() {
        if (_Cog6Tooth != null) {
            return _Cog6Tooth!!
        }
        _Cog6Tooth = ImageVector.Builder(
            name = "Filled.Cog6Tooth",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(7.493f, 7.493f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.986f, 0.57f)
                curveToRelative(-0.166f, 0.115f, -0.334f, 0.126f, -0.45f, 0.083f)
                lineTo(6.3f, 5.508f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.282f, 0.819f)
                lineToRelative(-0.922f, 1.597f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.432f, 2.385f)
                lineToRelative(0.84f, 0.692f)
                curveToRelative(0.095f, 0.078f, 0.17f, 0.229f, 0.154f, 0.43f)
                arcToRelative(7.598f, 7.598f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 1.139f)
                curveToRelative(0.015f, 0.2f, -0.059f, 0.352f, -0.153f, 0.43f)
                lineToRelative(-0.841f, 0.692f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.432f, 2.385f)
                lineToRelative(0.922f, 1.597f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.282f, 0.818f)
                ...
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.28f, -0.819f)
                lineToRelative(0.923f, -1.597f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.432f, -2.385f)
                lineToRelative(-0.84f, -0.692f)
                curveToRelative(-0.095f, -0.078f, -0.17f, -0.229f, -0.154f, -0.43f)
                arcToRelative(7.614f, 7.614f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -1.139f)
                ...
                arcToRelative(7.49f, 7.49f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.985f, -0.57f)
                curveToRelative(-0.183f, -0.087f, -0.277f, -0.227f, -0.297f, -0.348f)
                lineToRelative(-0.179f, -1.072f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.85f, -1.567f)
