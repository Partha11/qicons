    ...
    get() {
        ...
        _ChatBubbleOvalLeftEllipsis = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(6.707f, 6.707f, 0f, isMoreThanHalf = false, isPositiveArc = false, 6f, 21.75f)
                arcToRelative(6.721f, 6.721f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3.583f, -1.029f)
                ...
                arcToRelative(3.73f, 3.73f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.814f, 1.686f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.44f, 1.223f)
                close()
