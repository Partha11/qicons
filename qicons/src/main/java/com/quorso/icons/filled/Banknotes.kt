...
val QIcons.Filled.Banknotes: ImageVector
    get() {
        if (_Banknotes != null) {
            return _Banknotes!!
        }
        _Banknotes = ImageVector.Builder(
            name = "Filled.Banknotes",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcTo(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.5f, 14.625f)
                verticalLineToRelative(-9.75f)
                close()
                moveTo(8.25f, 9.75f)
                ...
                close()
                moveTo(4.5f, 9.75f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.25f, 9f)
                horizontalLineToRelative(0.008f)
