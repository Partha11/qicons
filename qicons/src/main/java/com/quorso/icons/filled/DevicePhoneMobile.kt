    ...
    get() {
        ...
        _DevicePhoneMobile = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(8.625f, 0.75f)
                arcTo(3.375f, 3.375f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.25f, 4.125f)
                ...
                arcTo(3.375f, 3.375f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15.375f, 0.75f)
                horizontalLineToRelative(-6.75f)
                close()
                moveTo(7.5f, 4.125f)
                ...
                curveToRelative(0f, 0.621f, -0.504f, 1.125f, -1.125f, 1.125f)
                horizontalLineToRelative(-6.75f)
                arcTo(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 7.5f, 19.875f)
                verticalLineTo(4.125f)
                close()
            }
        }.build()
