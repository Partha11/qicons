    ...
    get() {
        ...
        _ChatBubbleLeft = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.39f, 0.39f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.266f, 0.112f)
                lineTo(8.78f, 21.53f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 7.5f, 21f)
                verticalLineToRelative(-3.955f)
                arcToRelative(48.842f, 48.842f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.652f, -0.316f)
