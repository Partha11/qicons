...
val QIcons.Filled.Tag: ImageVector
    get() {
        if (_Tag != null) {
            return _Tag!!
        }
        _Tag = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.879f, 2.121f)
                lineToRelative(9.58f, 9.581f)
                curveToRelative(0.92f, 0.92f, 2.39f, 1.186f, 3.548f, 0.428f)
                arcToRelative(18.849f, 18.849f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.441f, -5.44f)
                curveToRelative(0.758f, -1.16f, 0.492f, -2.629f, -0.428f, -3.548f)
                lineToRelative(-9.58f, -9.581f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.122f, -0.879f)
