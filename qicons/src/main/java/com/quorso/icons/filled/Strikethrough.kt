...
val QIcons.Filled.Strikethrough: ImageVector
    get() {
        ...
        _Strikethrough = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.66f, 0.66f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.02f, 0f)
                lineTo(3.75f, 12.75f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -1.5f)
                horizontalLineToRelative(4.78f)
                arcToRelative(7.108f, 7.108f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.175f, -1.074f)
                ...
                arcTo(8.937f, 8.937f, 0f, isMoreThanHalf = false, isPositiveArc = true, 16.94f, 4.6f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.881f, 1.215f)
                arcToRelative(7.437f, 7.437f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.436f, -1.14f)
                curveToRelative(-1.473f, -0.394f, -2.885f, -0.331f, -3.966f, 0.052f)
                close()
                moveTo(16.19f, 14.36f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.134f, -0.982f)
                curveToRelative(0.746f, 0.862f, 1.93f, 1.612f, 3.388f, 2.003f)
