...
val QIcons.Filled.Users: ImageVector
    get() {
        if (_Users != null) {
            return _Users!!
        }
        _Users = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.233f, 0.96f)
                arcToRelative(10.088f, 10.088f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.06f, -1.01f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.42f, -0.643f)
                arcToRelative(4.875f, 4.875f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.957f, -4.611f)
                arcToRelative(8.586f, 8.586f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.71f, 5.157f)
                verticalLineToRelative(0.003f)
                close()
            }
        }.build()
