...
val QIcons.Filled.CircleStack: ImageVector
    get() {
        if (_CircleStack != null) {
            return _CircleStack!!
        }
        _CircleStack = ImageVector.Builder(
            name = "Filled.CircleStack",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(8.283f, 8.283f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.897f, -1.384f)
                ...
                arcToRelative(8.285f, 8.285f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.897f, 1.384f)
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 16.5f)
                curveToRelative(2.685f, 0f, 5.19f, -0.586f, 7.078f, -1.609f)
                arcToRelative(8.282f, 8.282f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.897f, -1.384f)
                curveToRelative(0.016f, 0.121f, 0.025f, 0.244f, 0.025f, 0.368f)
                curveToRelative(0f, 2.692f, -4.03f, 4.875f, -9f, 4.875f)
                reflectiveCurveToRelative(-9f, -2.183f, -9f, -4.875f)
                curveToRelative(0f, -0.124f, 0.009f, -0.247f, 0.025f, -0.368f)
                arcToRelative(8.284f, 8.284f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.897f, 1.384f)
