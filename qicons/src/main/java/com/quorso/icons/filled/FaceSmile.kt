...
val QIcons.Filled.FaceSmile: ImageVector
    get() {
        if (_FaceSmile != null) {
            return _FaceSmile!!
        }
        _FaceSmile = ImageVector.Builder(
            name = "Filled.FaceSmile",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3.75f, 3.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -5.304f, 0f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.06f, 1.06f)
                arcToRelative(5.25f, 5.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 7.424f, 0f)
                close()
            }
        }.build()
