    ...
    get() {
        ...
        _PhoneArrowDownLeft = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.694f, 1.955f)
                lineToRelative(-1.293f, 0.97f)
                curveToRelative(-0.135f, 0.101f, -0.164f, 0.249f, -0.126f, 0.352f)
                arcToRelative(11.285f, 11.285f, 0f, isMoreThanHalf = false, isPositiveArc = false, 6.697f, 6.697f)
                curveToRelative(0.103f, 0.038f, 0.25f, 0.009f, 0.352f, -0.126f)
                lineToRelative(0.97f, -1.293f)
                arcToRelative(1.875f, 1.875f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.955f, -0.694f)
