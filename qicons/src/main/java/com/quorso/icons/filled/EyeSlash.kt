...
val QIcons.Filled.EyeSlash: ImageVector
    get() {
        if (_EyeSlash != null) {
            return _EyeSlash!!
        }
        _EyeSlash = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(11.249f, 11.249f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.631f, 4.31f)
                lineToRelative(-3.099f, -3.099f)
                arcToRelative(5.25f, 5.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.71f, -6.71f)
                lineTo(7.759f, 4.577f)
                arcToRelative(11.217f, 11.217f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.242f, -0.827f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(3.75f, 3.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 15.75f, 12f)
                close()
                moveTo(12.53f, 15.713f)
                lineToRelative(-4.243f, -4.244f)
                arcToRelative(3.75f, 3.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4.244f, 4.243f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
                moveTo(6.75f, 12f)
                ...
                arcToRelative(11.25f, 11.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.63f, 4.31f)
                ...
                arcTo(5.25f, 5.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.75f, 12f)
                close()
            }
        }.build()
