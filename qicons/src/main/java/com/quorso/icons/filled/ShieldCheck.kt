...
val QIcons.Filled.ShieldCheck: ImageVector
    get() {
        ...
        _ShieldCheck = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.032f, 0f)
                arcToRelative(11.209f, 11.209f, 0f, isMoreThanHalf = false, isPositiveArc = true, -7.877f, 3.08f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.722f, 0.515f)
                arcTo(12.74f, 12.74f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.25f, 9.75f)
                curveToRelative(0f, 5.942f, 4.064f, 10.933f, 9.563f, 12.348f)
                arcToRelative(0.749f, 0.749f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.374f, 0f)
                curveToRelative(5.499f, -1.415f, 9.563f, -6.406f, 9.563f, -12.348f)
                curveToRelative(0f, -1.39f, -0.223f, -2.73f, -0.635f, -3.985f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.722f, -0.516f)
