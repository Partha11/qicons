    ...
    get() {
        ...
        _ChatBubbleLeftEllipsis = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.39f, 0.39f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.266f, -0.112f)
                ...
                arcTo(49.145f, 49.145f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 2.25f)
                close()
                moveTo(8.25f, 8.625f)
