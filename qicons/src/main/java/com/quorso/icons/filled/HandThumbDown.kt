    ...
    get() {
        ...
        _HandThumbDown = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(7.465f, 7.465f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 9.625f)
                arcToRelative(7.465f, 7.465f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.235f, 4.125f)
                horizontalLineToRelative(-0.148f)
                curveToRelative(-0.806f, 0f, -1.534f, 0.446f, -2.031f, 1.08f)
                arcToRelative(9.04f, 9.04f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.861f, 2.4f)
                curveToRelative(-0.723f, 0.384f, -1.35f, 0.956f, -1.653f, 1.715f)
                arcToRelative(4.499f, 4.499f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.322f, 1.672f)
                verticalLineToRelative(0.633f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 9f, 22f)
                ...
                arcTo(12.137f, 12.137f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.5f, 12.25f)
                curveToRelative(0f, -2.848f, 0.992f, -5.464f, 2.649f, -7.521f)
                curveTo(4.537f, 4.247f, 5.136f, 4f, 5.754f, 4f)
                horizontalLineTo(9.77f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.423f, 0.23f)
                lineToRelative(3.114f, 1.04f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.423f, 0.23f)
                close()
                ...
                arcToRelative(8.958f, 8.958f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.302f, 4.666f)
