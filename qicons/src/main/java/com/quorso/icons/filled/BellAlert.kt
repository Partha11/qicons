...
val QIcons.Filled.BellAlert: ImageVector
    get() {
        if (_BellAlert != null) {
            return _BellAlert!!
        }
        _BellAlert = ImageVector.Builder(
            name = "Filled.BellAlert",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(5.85f, 3.5f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.117f, -1f)
                arcToRelative(9.719f, 9.719f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.348f, 4.876f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.479f, 0.248f)
                arcTo(8.219f, 8.219f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.85f, 3.5f)
                close()
                moveTo(19.267f, 2.5f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.118f, 1f)
                arcToRelative(8.22f, 8.22f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.987f, 4.124f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.48f, -0.248f)
                arcTo(9.72f, 9.72f, 0f, isMoreThanHalf = false, isPositiveArc = false, 19.266f, 2.5f)
                close()
            }
            path(
