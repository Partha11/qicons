...
val QIcons.Filled.AtSymbol: ImageVector
    get() {
        if (_AtSymbol != null) {
            return _AtSymbol!!
        }
        _AtSymbol = ImageVector.Builder(
            name = "Filled.AtSymbol",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(8.25f, 8.25f, 0f, isMoreThanHalf = true, isPositiveArc = false, 0f, 11.668f)
                ...
                curveToRelative(3.807f, -3.808f, 9.98f, -3.808f, 13.788f, 0f)
                arcTo(9.722f, 9.722f, 0f, isMoreThanHalf = false, isPositiveArc = true, 21.75f, 12f)
                ...
                arcToRelative(5.25f, 5.25f, 0f, isMoreThanHalf = true, isPositiveArc = true, -0.82f, -6.26f)
                ...
                arcToRelative(8.222f, 8.222f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.416f, -5.834f)
                close()
                moveTo(15.75f, 12f)
