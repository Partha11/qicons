    ...
    get() {
        ...
        _DocumentCurrencyDollar = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(9.727f, 9.727f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.687f, 0.28f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = true, isPositiveArc = true, -0.374f, 1.452f)
                arcToRelative(8.207f, 8.207f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.313f, -0.226f)
                ...
                arcToRelative(9.776f, 9.776f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.561f, 0.059f)
                verticalLineToRelative(0.028f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.5f, 0f)
                verticalLineToRelative(-0.029f)
                arcToRelative(9.724f, 9.724f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.687f, -0.278f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.374f, -1.453f)
