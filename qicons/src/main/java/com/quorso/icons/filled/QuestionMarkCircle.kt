    ...
    get() {
        ...
        _QuestionMarkCircle = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.988f, -1.129f)
                curveToRelative(1.454f, -1.272f, 3.776f, -1.272f, 5.23f, 0f)
                curveToRelative(1.513f, 1.324f, 1.513f, 3.518f, 0f, 4.842f)
                arcToRelative(3.75f, 3.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.837f, 0.552f)
