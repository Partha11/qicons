    ...
    get() {
        ...
        _GlobeAmericas = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(8.25f, 8.25f, 0f, isMoreThanHalf = true, isPositiveArc = false, 10.562f, -0.766f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.318f, 1.357f)
                lineTo(14.25f, 7.5f)
                lineToRelative(0.165f, 0.33f)
                arcToRelative(0.809f, 0.809f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.086f, 1.085f)
                lineToRelative(-0.604f, -0.302f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.298f, 0.21f)
                ...
                arcToRelative(8.7f, 8.7f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.288f, 4.04f)
                lineToRelative(-0.723f, 0.724f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.298f, 0.21f)
                lineToRelative(-0.153f, -0.076f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.622f, -1.006f)
                verticalLineToRelative(-1.089f)
                curveToRelative(0f, -0.298f, -0.119f, -0.585f, -0.33f, -0.796f)
                lineToRelative(-1.347f, -1.347f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.21f, -1.298f)
                lineTo(9.75f, 12f)
                lineToRelative(-1.64f, -1.64f)
                arcToRelative(6f, 6f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.676f, -3.257f)
