...
val QIcons.Filled.FolderOpen: ImageVector
    get() {
        if (_FolderOpen != null) {
            return _FolderOpen!!
        }
        _FolderOpen = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(3.756f, 3.756f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.094f, 9f)
                horizontalLineToRelative(15.812f)
                close()
                moveTo(4.094f, 10.5f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.227f, 2.568f)
                lineToRelative(0.857f, 6f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4.951f, 21f)
