    ...
    get() {
        ...
        _InboxArrowDown = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.912f, 4.5f)
                horizontalLineTo(9f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9f, 3f)
                ...
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.434f, 1.059f)
                lineToRelative(2.213f, 7.191f)
                horizontalLineTo(17.89f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.684f, 1.658f)
                lineToRelative(-0.256f, 0.513f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.342f, 0.829f)
                horizontalLineToRelative(-3.218f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.342f, -0.83f)
