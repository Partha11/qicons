    ...
    get() {
        ...
        _ClipboardDocumentCheck = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(3.375f, 3.375f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 9.375f)
                verticalLineToRelative(9.375f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3f, -3f)
                verticalLineTo(6.108f)
                curveToRelative(0f, -1.505f, -1.125f, -2.811f, -2.664f, -2.94f)
                arcToRelative(48.972f, 48.972f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.673f, -0.05f)
                arcTo(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15f, 1.5f)
                horizontalLineToRelative(-1.5f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.663f, 1.618f)
                curveToRelative(-0.225f, 0.015f, -0.45f, 0.032f, -0.673f, 0.05f)
                curveTo(8.662f, 3.295f, 7.554f, 4.542f, 7.502f, 6f)
                close()
                moveTo(13.5f, 3f)
                arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 12f, 4.5f)
                horizontalLineToRelative(4.5f)
                arcTo(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15f, 3f)
                horizontalLineToRelative(-1.5f)
                close()
            }
            path(
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.172f, -0.938f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.116f, -0.062f)
