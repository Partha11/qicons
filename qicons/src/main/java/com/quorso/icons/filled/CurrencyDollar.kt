    ...
    get() {
        ...
        _CurrencyDollar = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(2.252f, 2.252f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.786f, -0.393f)
                ...
                arcToRelative(2.534f, 2.534f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.921f, 0.42f)
                close()
            }
            path(
                ...
                arcToRelative(3.836f, 3.836f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.72f, 0.756f)
                ...
                arcToRelative(2.536f, 2.536f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.921f, -0.421f)
                lineToRelative(-0.879f, -0.66f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.9f, 1.2f)
                lineToRelative(0.879f, 0.66f)
                curveToRelative(0.533f, 0.4f, 1.169f, 0.645f, 1.821f, 0.75f)
                verticalLineTo(18f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.5f, 0f)
                verticalLineToRelative(-0.81f)
                arcToRelative(4.124f, 4.124f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.821f, -0.749f)
                curveToRelative(0.745f, -0.559f, 1.179f, -1.344f, 1.179f, -2.191f)
                curveToRelative(0f, -0.847f, -0.434f, -1.632f, -1.179f, -2.191f)
                arcToRelative(4.122f, 4.122f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.821f, -0.75f)
                verticalLineTo(8.354f)
                curveToRelative(0.29f, 0.082f, 0.559f, 0.213f, 0.786f, 0.393f)
                lineToRelative(0.415f, 0.33f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.933f, -1.175f)
                lineToRelative(-0.415f, -0.33f)
                arcToRelative(3.836f, 3.836f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.719f, -0.755f)
                verticalLineTo(6f)
                close()
            }
        }.build()
