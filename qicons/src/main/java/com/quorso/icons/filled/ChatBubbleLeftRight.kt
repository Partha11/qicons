    ...
    get() {
        ...
        _ChatBubbleLeftRight = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(4.403f, 4.403f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.032f, -0.211f)
                arcToRelative(50.89f, 50.89f, 0f, isMoreThanHalf = false, isPositiveArc = false, -8.42f, 0f)
                curveToRelative(-2.358f, 0.196f, -4.04f, 2.19f, -4.04f, 4.434f)
                verticalLineToRelative(4.286f)
                arcToRelative(4.47f, 4.47f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.433f, 3.984f)
                lineTo(7.28f, 21.53f)
                arcTo(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 21f)
                verticalLineToRelative(-4.03f)
                arcToRelative(48.527f, 48.527f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.087f, -0.128f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(49.392f, 49.392f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15.75f, 7.5f)
                close()
            }
        }.build()
