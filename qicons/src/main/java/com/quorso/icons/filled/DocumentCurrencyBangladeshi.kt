    ...
    get() {
        ...
        _DocumentCurrencyBangladeshi = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.993f, -2.123f)
                curveToRelative(0.233f, -0.487f, 0.14f, -1f, -0.136f, -1.37f)
                arcTo(1.459f, 1.459f, 0f, isMoreThanHalf = false, isPositiveArc = false, 14.757f, 15f)
                horizontalLineToRelative(-0.507f)
                arcToRelative(0.75f, 0.75f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, 1.5f)
                horizontalLineToRelative(0.349f)
                arcToRelative(2.999f, 2.999f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3.887f, 1.21f)
