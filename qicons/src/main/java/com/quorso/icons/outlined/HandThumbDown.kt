    ...
    get() {
        ...
        _HandThumbDown = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(12.137f, 12.137f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.068f, -1.285f)
                ...
                arcTo(7.471f, 7.471f, 0f, isMoreThanHalf = false, isPositiveArc = false, 7.5f, 19.75f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 9.75f, 22f)
                ...
                arcToRelative(9.04f, 9.04f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.86f, -2.4f)
                ...
                arcToRelative(8.95f, 8.95f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.303f, -0.54f)
            }
        }.build()
