...
val QIcons.Outlined.Clipboard: ImageVector
    get() {
        if (_Clipboard != null) {
            return _Clipboard!!
        }
        _Clipboard = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 13.5f, 2.25f)
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.5f, 19.5f)
                verticalLineTo(6.257f)
                curveToRelative(0f, -1.108f, 0.806f, -2.057f, 1.907f, -2.185f)
                arcToRelative(48.208f, 48.208f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.927f, -0.184f)
            }
        }.build()
