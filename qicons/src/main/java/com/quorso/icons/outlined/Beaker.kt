...
val QIcons.Outlined.Beaker: ImageVector
    get() {
        if (_Beaker != null) {
            return _Beaker!!
        }
        _Beaker = ImageVector.Builder(
            name = "Outlined.Beaker",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(24.301f, 24.301f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.5f, 0f)
                ...
                arcTo(9.065f, 9.065f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12f, 15f)
                arcToRelative(9.065f, 9.065f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.23f, -0.693f)
                lineTo(5f, 14.5f)
                moveToRelative(14.8f, 0.8f)
                lineToRelative(1.402f, 1.402f)
                curveToRelative(1.232f, 1.232f, 0.65f, 3.318f, -1.067f, 3.611f)
                arcTo(48.309f, 48.309f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12f, 21f)
