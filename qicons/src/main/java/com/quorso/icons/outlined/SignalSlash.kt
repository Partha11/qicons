...
val QIcons.Outlined.SignalSlash: ImageVector
    get() {
        if (_SignalSlash != null) {
            return _SignalSlash!!
        }
        _SignalSlash = ImageVector.Builder(
            name = "Outlined.SignalSlash",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(0.374f, 0.374f, 0f, isMoreThanHalf = true, isPositiveArc = true, 0.53f, 0.53f)
                ...
                arcToRelative(3.733f, 3.733f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.06f, -2.122f)
                moveToRelative(-1.061f, 4.243f)
                arcToRelative(6.75f, 6.75f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.625f, -6.929f)
