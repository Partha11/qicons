    ...
    get() {
        ...
        _ChatBubbleLeftRight = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2.115f, 2.115f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.825f, -0.242f)
                moveToRelative(9.345f, -8.334f)
                arcToRelative(2.126f, 2.126f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.476f, -0.095f)
                arcToRelative(48.64f, 48.64f, 0f, isMoreThanHalf = false, isPositiveArc = false, -8.048f, 0f)
                ...
                arcTo(48.455f, 48.455f, 0f, isMoreThanHalf = false, isPositiveArc = false, 11.25f, 3f)
