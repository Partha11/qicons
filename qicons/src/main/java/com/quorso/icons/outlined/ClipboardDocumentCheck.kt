    ...
    get() {
        ...
        _ClipboardDocumentCheck = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 18.75f)
