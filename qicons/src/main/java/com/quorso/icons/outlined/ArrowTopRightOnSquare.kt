    ...
    get() {
        ...
        _ArrowTopRightOnSquare = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3f, 8.25f)
                verticalLineToRelative(10.5f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.25f, 21f)
                horizontalLineToRelative(10.5f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = false, 18f, 18.75f)
