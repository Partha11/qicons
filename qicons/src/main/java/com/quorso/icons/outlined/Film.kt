...
val QIcons.Outlined.Film: ImageVector
    get() {
        if (_Film != null) {
            return _Film!!
        }
        _Film = ImageVector.Builder(
            ...
            path(
                ...
                horizontalLineToRelative(-1.5f)
                arcTo(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 18.375f)
                moveTo(20.625f, 4.5f)
                ...
                horizontalLineToRelative(1.5f)
                moveToRelative(-1.5f, 0f)
                arcTo(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 7.125f)
                verticalLineToRelative(-1.5f)
                moveToRelative(1.125f, 2.625f)
                curveToRelative(-0.621f, 0f, -1.125f, 0.504f, -1.125f, 1.125f)
                verticalLineToRelative(1.5f)
                ...
                arcTo(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 10.875f)
                moveTo(7.125f, 12f)
