...
val QIcons.Outlined.Wrench: ImageVector
    get() {
        if (_Wrench != null) {
            return _Wrench!!
        }
        _Wrench = ImageVector.Builder(
            name = "Outlined.Wrench",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(21.75f, 6.75f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.884f, 4.484f)
                ...
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6.336f, -4.486f)
                lineToRelative(-3.276f, 3.276f)
                arcToRelative(3.004f, 3.004f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.25f, 2.25f)
                lineToRelative(3.276f, -3.276f)
