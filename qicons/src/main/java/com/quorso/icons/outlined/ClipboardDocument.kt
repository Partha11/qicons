    ...
    get() {
        ...
        _ClipboardDocument = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(3.375f, 3.375f, 0f, isMoreThanHalf = false, isPositiveArc = false, 6.375f, 7.5f)
                horizontalLineTo(5.25f)
                moveToRelative(11.9f, -3.664f)
                arcTo(2.251f, 2.251f, 0f, isMoreThanHalf = false, isPositiveArc = false, 15f, 2.25f)
                horizontalLineToRelative(-1.5f)
                arcToRelative(2.251f, 2.251f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.15f, 1.586f)
