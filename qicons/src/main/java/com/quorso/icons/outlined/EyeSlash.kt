...
val QIcons.Outlined.EyeSlash: ImageVector
    get() {
        if (_EyeSlash != null) {
            return _EyeSlash!!
        }
        _EyeSlash = ImageVector.Builder(
            name = "Outlined.EyeSlash",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(3.98f, 8.223f)
                arcTo(10.477f, 10.477f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.934f, 12f)
                curveTo(3.226f, 16.338f, 7.244f, 19.5f, 12f, 19.5f)
                curveToRelative(0.993f, 0f, 1.953f, -0.138f, 2.863f, -0.395f)
                moveTo(6.228f, 6.228f)
                arcTo(10.451f, 10.451f, 0f, isMoreThanHalf = false, isPositiveArc = true, 12f, 4.5f)
                curveToRelative(4.756f, 0f, 8.773f, 3.162f, 10.065f, 7.498f)
                arcToRelative(10.522f, 10.522f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.293f, 5.774f)
                moveTo(6.228f, 6.228f)
                lineTo(3f, 3f)
