...
val QIcons.Outlined.Trash: ImageVector
    get() {
        if (_Trash != null) {
            return _Trash!!
        }
        _Trash = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.244f, 2.077f)
                horizontalLineTo(8.084f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.244f, -2.077f)
                lineTo(4.772f, 5.79f)
                moveToRelative(14.456f, 0f)
                arcToRelative(48.108f, 48.108f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.478f, -0.397f)
                moveToRelative(-12f, 0.562f)
                curveToRelative(0.34f, -0.059f, 0.68f, -0.114f, 1.022f, -0.165f)
                moveToRelative(0f, 0f)
                arcToRelative(48.11f, 48.11f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.478f, -0.397f)
                moveToRelative(7.5f, 0f)
                verticalLineToRelative(-0.916f)
                curveToRelative(0f, -1.18f, -0.91f, -2.164f, -2.09f, -2.201f)
                arcToRelative(51.964f, 51.964f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.32f, 0f)
