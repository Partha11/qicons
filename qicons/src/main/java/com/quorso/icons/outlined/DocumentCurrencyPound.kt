    ...
    get() {
        ...
        _DocumentCurrencyPound = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, -5.02f, 2.897f)
                lineToRelative(0.164f, 0.609f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.108f, 2.676f)
                lineToRelative(-0.157f, 0.439f)
                lineToRelative(0.44f, -0.22f)
                arcToRelative(2.863f, 2.863f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.185f, -0.155f)
