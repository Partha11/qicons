...
val QIcons.Outlined.Cog6Tooth: ImageVector
    get() {
        if (_Cog6Tooth != null) {
            return _Cog6Tooth!!
        }
        _Cog6Tooth = ImageVector.Builder(
            name = "Outlined.Cog6Tooth",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.37f, 0.49f)
                lineToRelative(1.296f, 2.247f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.26f, 1.431f)
                lineToRelative(-1.003f, 0.827f)
                curveToRelative(-0.293f, 0.241f, -0.438f, 0.613f, -0.43f, 0.992f)
                arcToRelative(7.723f, 7.723f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, 0.255f)
                ...
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.369f, 0.491f)
                lineToRelative(-1.217f, -0.456f)
                curveToRelative(-0.355f, -0.133f, -0.75f, -0.072f, -1.076f, 0.124f)
                arcToRelative(6.47f, 6.47f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.22f, 0.128f)
                ...
                arcToRelative(6.52f, 6.52f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.22f, -0.127f)
                curveToRelative(-0.325f, -0.196f, -0.72f, -0.257f, -1.076f, -0.124f)
                lineToRelative(-1.217f, 0.456f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.369f, -0.49f)
                lineToRelative(-1.297f, -2.247f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.26f, -1.431f)
                lineToRelative(1.004f, -0.827f)
                curveToRelative(0.292f, -0.24f, 0.437f, -0.613f, 0.43f, -0.991f)
                arcToRelative(6.932f, 6.932f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -0.255f)
                curveToRelative(0.007f, -0.38f, -0.138f, -0.751f, -0.43f, -0.992f)
                lineToRelative(-1.004f, -0.827f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.26f, -1.43f)
                lineToRelative(1.297f, -2.247f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.37f, -0.491f)
