...
val QIcons.Outlined.PuzzlePiece: ImageVector
    get() {
        if (_PuzzlePiece != null) {
            return _PuzzlePiece!!
        }
        _PuzzlePiece = ImageVector.Builder(
            name = "Outlined.PuzzlePiece",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(0.64f, 0.64f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.657f, 0.643f)
                arcToRelative(48.39f, 48.39f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.163f, -0.3f)
                curveToRelative(0.186f, 1.613f, 0.293f, 3.25f, 0.315f, 4.907f)
                arcToRelative(0.656f, 0.656f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.658f, 0.663f)
                verticalLineToRelative(0f)
                ...
                arcToRelative(48.039f, 48.039f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.642f, 5.056f)
                curveToRelative(1.518f, 0.19f, 3.058f, 0.309f, 4.616f, 0.354f)
                arcToRelative(0.64f, 0.64f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.657f, -0.643f)
                verticalLineToRelative(0f)
                curveToRelative(0f, -0.355f, -0.186f, -0.676f, -0.401f, -0.959f)
                ...
                arcToRelative(48.1f, 48.1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.427f, -0.63f)
                arcToRelative(48.05f, 48.05f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.582f, -4.717f)
                arcToRelative(0.532f, 0.532f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.533f, -0.57f)
                verticalLineToRelative(0f)
                curveToRelative(-0.355f, 0f, -0.676f, 0.186f, -0.959f, 0.401f)
                ...
                verticalLineToRelative(0f)
                arcToRelative(0.656f, 0.656f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.658f, -0.663f)
                arcToRelative(48.422f, 48.422f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.37f, -5.36f)
                curveToRelative(-1.886f, 0.342f, -3.81f, 0.574f, -5.766f, 0.689f)
                arcToRelative(0.578f, 0.578f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.61f, -0.58f)
                verticalLineToRelative(0f)
                close()
            }
        }.build()
