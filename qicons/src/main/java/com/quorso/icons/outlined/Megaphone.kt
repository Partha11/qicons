...
val QIcons.Outlined.Megaphone: ImageVector
    get() {
        if (_Megaphone != null) {
            return _Megaphone!!
        }
        _Megaphone = ImageVector.Builder(
            name = "Outlined.Megaphone",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(20.845f, 20.845f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.44f, -4.282f)
                moveToRelative(3.102f, 0.069f)
                arcToRelative(18.03f, 18.03f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.59f, -4.59f)
                curveToRelative(0f, -1.586f, 0.205f, -3.124f, 0.59f, -4.59f)
                moveToRelative(0f, 9.18f)
                arcToRelative(23.848f, 23.848f, 0f, isMoreThanHalf = false, isPositiveArc = true, 8.835f, 2.535f)
                moveTo(10.34f, 6.66f)
                arcToRelative(23.847f, 23.847f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.835f, -2.535f)
                moveToRelative(0f, 0f)
                arcTo(23.74f, 23.74f, 0f, isMoreThanHalf = false, isPositiveArc = false, 18.795f, 3f)
                moveToRelative(0.38f, 1.125f)
                arcToRelative(23.91f, 23.91f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.014f, 5.395f)
                moveToRelative(-1.014f, 8.855f)
                curveToRelative(-0.118f, 0.38f, -0.245f, 0.754f, -0.38f, 1.125f)
                moveToRelative(0.38f, -1.125f)
                arcToRelative(23.91f, 23.91f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.014f, -5.395f)
                ...
                moveToRelative(0f, -3.46f)
                arcToRelative(24.347f, 24.347f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, 3.46f)
            }
        }.build()
