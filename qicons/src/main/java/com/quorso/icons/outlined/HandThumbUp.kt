...
val QIcons.Outlined.HandThumbUp: ImageVector
    get() {
        if (_HandThumbUp != null) {
            return _HandThumbUp!!
        }
        _HandThumbUp = ImageVector.Builder(
            name = "Outlined.HandThumbUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.041f, 9.041f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.861f, -2.4f)
                ...
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.521f, -3.507f)
                ...
                arcToRelative(8.958f, 8.958f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.302f, 4.665f)
