...
val QIcons.Outlined.Language: ImageVector
    get() {
        if (_Language != null) {
            return _Language!!
        }
        _Language = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(3f, 5.621f)
                arcToRelative(48.474f, 48.474f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, -0.371f)
                ...
                arcToRelative(18.023f, 18.023f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3.827f, -5.802f)
            }
        }.build()
