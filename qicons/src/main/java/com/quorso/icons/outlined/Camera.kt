...
val QIcons.Outlined.Camera: ImageVector
    get() {
        if (_Camera != null) {
            return _Camera!!
        }
        _Camera = ImageVector.Builder(
            ...
            path(
                ...
                arcTo(2.31f, 2.31f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.186f, 7.23f)
                ...
                arcToRelative(47.865f, 47.865f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.134f, -0.175f)
                arcToRelative(2.31f, 2.31f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.64f, -1.055f)
                lineToRelative(-0.822f, -1.316f)
                arcToRelative(2.192f, 2.192f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.736f, -1.039f)
                arcToRelative(48.774f, 48.774f, 0f, isMoreThanHalf = false, isPositiveArc = false, -5.232f, 0f)
                arcToRelative(2.192f, 2.192f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.736f, 1.039f)
