...
val QIcons.Outlined.Cake: ImageVector
    get() {
        if (_Cake != null) {
            return _Cake!!
        }
        _Cake = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(3.354f, 3.354f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3f, 0f)
                arcToRelative(3.354f, 3.354f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3f, 0f)
                arcToRelative(3.354f, 3.354f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3f, 0f)
                arcToRelative(3.354f, 3.354f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3f, 0f)
                arcToRelative(3.354f, 3.354f, 0f, isMoreThanHalf = false, isPositiveArc = true, -3f, 0f)
                lineTo(3f, 16.5f)
                moveToRelative(15f, -3.379f)
                arcToRelative(48.474f, 48.474f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6f, -0.371f)
                ...
                lineTo(4.125f, 21.75f)
                arcTo(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3f, 20.625f)
                verticalLineToRelative(-5.17f)
                curveToRelative(0f, -1.08f, 0.768f, -2.014f, 1.837f, -2.174f)
                arcTo(47.78f, 47.78f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 13.12f)
                moveTo(12.265f, 3.11f)
                arcToRelative(0.375f, 0.375f, 0f, isMoreThanHalf = true, isPositiveArc = true, -0.53f, 0f)
                lineTo(12f, 2.845f)
