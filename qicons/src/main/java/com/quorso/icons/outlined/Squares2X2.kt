...
val QIcons.Outlined.Squares2X2: ImageVector
    get() {
        if (_Squares2X2 != null) {
            return _Squares2X2!!
        }
        _Squares2X2 = ImageVector.Builder(
            name = "Outlined.Squares2X2",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 10.5f, 6f)
                ...
                close()
                moveTo(3.75f, 15.75f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 6f, 13.5f)
                horizontalLineToRelative(2.25f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.25f, 2.25f)
                verticalLineTo(18f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.25f, 2.25f)
                ...
                verticalLineToRelative(2.25f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 18f, 10.5f)
                horizontalLineToRelative(-2.25f)
                arcToRelative(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.25f, -2.25f)
                verticalLineTo(6f)
                close()
                ...
                horizontalLineToRelative(-2.25f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 13.5f, 18f)
                verticalLineToRelative(-2.25f)
                close()
            }
        }.build()
