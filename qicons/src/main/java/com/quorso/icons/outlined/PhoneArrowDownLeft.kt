    ...
    get() {
        ...
        _PhoneArrowDownLeft = ImageVector.Builder(
            ...
            path(
                ...
                verticalLineTo(4.5f)
                arcTo(2.25f, 2.25f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.5f, 2.25f)
                ...
                arcToRelative(1.062f, 1.062f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.38f, 1.21f)
                arcToRelative(12.035f, 12.035f, 0f, isMoreThanHalf = false, isPositiveArc = false, 7.143f, 7.143f)
                curveToRelative(0.441f, 0.162f, 0.928f, -0.004f, 1.21f, -0.38f)
                lineToRelative(0.97f, -1.293f)
                arcToRelative(1.125f, 1.125f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.173f, -0.417f)
